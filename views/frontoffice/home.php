    ...
    <div class="card-group">
      <div class="card">
        <img src="../public/images/oeufVerre.JPG" class="card-img-top" alt="oeuf en verre">
        <div class="card-body">
      ...
      <div class="card">
        <img src="../public/images/vase-sucre.JPG" class="card-img-top" alt="vase en sucre">
        <div class="card-body">
      ...
      <div class="card">
        <img src="../public/images/fleur-safran.JPG" class="card-img-top" alt="...">
        <div class="card-body">
